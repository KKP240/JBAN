  ...
  userEl.innerHTML = `<div class="username">
                              ...
                              <div class="drop-menu">
                                  <ul class="drop-menu__list">
                                      ${user.role === "customer" ? `<li class="drop-menu__item"><a href="/orderHistory" class="drop-menu__link">ประวัติคำสั่งซื้อ</a></li>` : `<li class="drop-menu__item"><a href="/manageProduct" class="drop-menu__link">จัดการสินค้า</a></li>`}
